...
export class AccueilComponent implements OnInit {
  ...
  constructor() { 
    ...
    this.collegue = [
      ...
      {pseudo:"Gretta", score: 5, photoURL: "https://i.imgur.com/bnsF26a.gif"},
      ...
      {pseudo:"Clitorine", score: 6, photoURL: "https://photos.travelblog.org/Photos/103181/523077/f/5360237-Pretty_punk_girl-0.jpg"},
